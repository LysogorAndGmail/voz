...
//print_r($_SERVER);
//die;
$workdir = $_SERVER['DOCUMENT_ROOT'].'/js/tinymce/uploads';
//$workdir = '/var/www/vhosts/svitgo.com/data.svitgo.com';
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    //$url = "http://data.svitgo.com";
    $url = '/js/tinymce/uploads';
    $path = $PARAMS["path"];
    //$pa = json_decode($path);    
    $DIR = explode("/",$path);
    //print_r($DIR);
