...
<div style="margin-left: 20px;">
     <h4 style="font-size: 25px;">Добавление блога</h4>
     
     <form id="add_material" action="/admin/add_blog" method="post" >
          
          <label>Ф.И.О<br />
            <input name="blog_name" type="text" style="width:500px;" value=""/>
          </label>
          <br />
          <label>Фото:<br />
                <input type="text" name="blog_foto" maxlength="255" value="" style="width:200px;" />
          </label>
          <br />
          <label>Email:<br />
                <input type="text" name="blog_email" maxlength="255" value="" style="width:200px;" />
          </label>
          <br />
          <div style="width:678px;">
          <label>Текст:<br />
            <textarea name="blog_text" class="moxiecut" rows="50"></textarea>
          </label>
          <br />
         </div>
