...
<div style="margin-left: 20px;">
     ...
     <form id="add_material" action="/admin/update_deputats?dep_id=<?=$edit_dep['dep_id'];?>" method="post" >
          ...
          <br />
          <label>Email:<br />
                <input type="text" name="dep_email" maxlength="255" value="<?=$edit_dep['dep_email'];?>" style="width:200px;" />
          </label>
          <br />
          <label>Округ:<br />
                <input type="text" name="dep_okrug" maxlength="255" value="<?=$edit_dep['dep_okrug'];?>" style="width:200px;" />
          </label>
          <br />
          <div style="width:678px;">
          <label>Текст:<br />
            <textarea name="dep_text" rows="50" class="moxiecut"><?=$edit_dep['dep_text'];?></textarea>
          </label>
          <br />
          </div>
