...
<div style="margin-left: 20px;">
     ...
     <form id="add_material" action="/moderator/update_material?material_id=<?=$edit_material['material_id'];?>" method="post" >
         ...
         <div class="blo">
              ...
              <? foreach($cats_parent as $cat){ ?>
                 <p><input type="radio" name="cat_mat" <?if($cat['moderator_cat_id'] == $edit_material['moderator_cat_id']){ echo 'checked="checked"';}?> value="<?=$cat['moderator_cat_id'];?>" /><?=$cat['moderator_cat_title'];?></p>
              <?}?>
              </div>
          </div>
