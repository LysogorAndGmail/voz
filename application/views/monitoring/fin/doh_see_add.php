    ...
    <div>
        <form method="POST">
            <table style="width: 100%;">
                ...
                <tr>
                    <td style="text-align: right; width: 50%;">Поступило (загальній фонд)</td>
                    <td style="text-align: left; width: 50%;"><input type="text" name="zag_fond_post" value="" style="width: 100%;" /></td>
                </tr>
                <tr>
                    <td style="text-align: right; width: 50%;">Поступило (спеціальний фонд)</td>
                    <td style="text-align: left; width: 50%;"><input type="text" name="spe_fond_post" value="" style="width: 100%;" /></td>
                </tr>
                <tr>
